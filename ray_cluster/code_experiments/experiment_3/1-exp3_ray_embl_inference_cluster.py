...
ds = ray.data.read_images(filesystem=fs, paths="s3://bucket/dataset/", include_paths=True, mode='RGB', file_extensions=None, ray_remote_args={"num_cpus": 6})
...
ds = ds.map_batches(preprocess, batch_format="numpy", num_cpus=6)
ds = ds.map_batches(Actor, batch_format="numpy", batch_size=BATCH_SIZE, num_cpus=6, concurrency=30)
