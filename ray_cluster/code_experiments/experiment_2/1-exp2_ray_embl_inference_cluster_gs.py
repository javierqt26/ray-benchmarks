...
def evaluate(params):
    ...
    ds = ray.data.read_images(filesystem=fs, paths=f"s3://bucket/{ds_name}/", include_paths=True, mode='RGB', file_extensions=None, ray_remote_args={"num_cpus": num_cpus})
...
for config in configurations:
    ...
    save_metrics_to_s3(avg_metrics, "metrics_embl_inference_cluster_exp2.csv", "bucket", fs)
