...
def evaluate(params):
    ds_name, parallelism_read, num_cpus, batch_size_map_batches, preserve_order = params
...
for config in configurations:
    ...
    save_metrics_to_s3(avg_metrics, "metrics_embl_preprocess_cluster_exp1.csv", "bucket", fs)
